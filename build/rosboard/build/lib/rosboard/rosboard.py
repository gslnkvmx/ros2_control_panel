...
class ROSBoardNode(object):
    ...
    def create_publisher(self, msg_type, topic, queue_size=10):
        """
        Create a ROS publisher for the given message type and topic.
        
        Args:
            msg_type: The message class (e.g., Bool, String, etc.)
            topic: The topic name to publish to
            queue_size: The queue size for the publisher (default: 10)
